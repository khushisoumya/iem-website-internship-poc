    ...
    <div>
      <section className="relative bg-[#0a1c4e] text-white overflow-hidden min-h-[500px] py-14 lg:py-0 lg:h-[500px]">
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-5 h-full flex flex-col justify-center py-8 lg:py-0">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 lg:mb-5 text-white">
            {heroTitle}
          </h1>

          <p className="text-base sm:text-xl text-gray-200 mb-4 lg:mb-5">
            {tagline}
          </p>

          <div className="w-16 h-1 bg-yellow-400 mb-5 lg:mb-6" />

          <p className="max-w-xl leading-7 sm:leading-8 text-gray-200 mb-6 lg:mb-8 text-sm sm:text-base">
            {heroSummary}
          </p>
